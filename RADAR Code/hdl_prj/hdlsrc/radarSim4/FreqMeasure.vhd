-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\radarSim4\FreqMeasure.vhd
...
-- 
-- Module: FreqMeasure
-- Source Path: radarSim4/radar/FreqMeasure
-- Hierarchy Level: 1
-- Model version: 1.37
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF FreqMeasure IS

  -- Component Declarations
  COMPONENT Short_Time_FFT1
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : Short_Time_FFT1
    USE ENTITY work.Short_Time_FFT1(rtl);
...
BEGIN
  u_Short_Time_FFT1 : Short_Time_FFT1
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
