...
create_generated_clock -source [get_ports S_AXI_ACLK] -divide_by 2 [get_pins "*/*.DbgReg_DRCK*/Q"]
create_generated_clock -source [get_ports S_AXI_ACLK] -divide_by 4 [get_pins "*/*.DbgReg_UPDATE*/Q"]
